...
public static class KeyMapper {
    ...
    static ushort[] voiceHotkey = new ushort[] { 0xA5, 0xBC }; // default RALT+OEM_COMMA

    public static ushort[] VoiceHotkey {
        get { lock (gate) return voiceHotkey; }
        set { lock (gate) voiceHotkey = (value != null && value.Length > 0) ? value : new ushort[] { 0xA5, 0xBC }; }
    }
